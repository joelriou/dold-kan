...
\node(compatibility) at (3.5,-17) {compatibility.lean};
\node(equivalenceadditive) at (0,-18) {equivalence\_additive.lean};
\node(equivalencepa) at (0,-20) {equivalence\_pseudoabelian.lean};
\node(equivalence) at (0,-22) {equivalence.lean};
\node(functorialityadditive) at (-5,-19) {functoriality\_additive.lean};
\node(functorialitypa) at (-5,-21) {functoriality\_pseudoabelian.lean};
\node(functoriality) at (-5,-23) {functoriality.lean};
